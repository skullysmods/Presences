...
import youtubeAutogeneratedResolver from './video_sources/autogenerated.js'
...
presence.on('UpdateData', async () => {
  ...
  if (video) {
    ...
    if (resolver === youtubeResolver || resolver === youtubeMobileResolver || resolver === youtubeAutogeneratedResolver) {
